...
//  gif = new GifMaker(this, "generative28.gif", 100);
//  gif.setRepeat(0);
...
// a class to store the x, y coordinates
class PointObj {
  float x, y;
...
class Branch {
  ...
  // calculate the midpoints of the lines of the pentagon
  ...
  // stretching a line from the midpoints to the edges of the inner pentagons
  ...
  PointObj calcProjPoint(PointObj mp, PointObj op) {
    ...
    // extend length based on the oblique side
    if (op.x > mp.x) {
